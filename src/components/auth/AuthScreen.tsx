...
export function AuthScreen() {
  ...
  return (
    <div className="min-h-screen bg-[#e6e4df] flex flex-col items-center justify-center font-sans p-5 transition-all duration-500">
      <div className="bg-[#fcfbf9] border border-gray-300 rounded-2xl p-10 max-w-md w-full shadow-lg flex flex-col items-center">
        ...
        <h1 className="text-3xl font-bold text-gray-800 mb-2 m-0">Operator</h1>
        ...
        <form onSubmit={handleEmailAuth} className="w-full flex flex-col gap-4">
          <div>
            ...
            <input 
              ...
              className="w-full px-4 py-3 bg-white border border-gray-300 rounded-xl outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all text-sm"
        ...
        <button 
          ...
          disabled={isLoading}
          className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-200 hover:border-gray-300 text-gray-700 font-bold py-3 px-6 rounded-xl transition-all shadow-sm disabled:opacity-50"
        >
